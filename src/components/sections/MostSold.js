...
export default function MostSold() {
    ...
    return (
        <section className="min-h-screen flex flex-col items-center justify-center gap-6">
            ...
            <section className="w-full py-8 md:py-16 flex flex-col items-center justify-center bg-[#fafafa] border border-gray-200 shadow-lg rounded-[32px] md:rounded-[48px] max-w-full md:max-w-[1600px] mx-auto">
                <StaggerContainer>
