...
export const metadata = {
    ...
    description: "Controllo completo della vista con strumentazione all'avanguardia. Prenota il tuo esame dell'acuità visiva presso Ottica Fazio ad Augusta e Villasmundo.",
                                ...
                                <StaggerItem direction="up">
                                    <div className="flex flex-col sm:flex-row gap-4 mt-8">
                                        <button 
                                            ...
                                            aria-label="Prenota un esame dell'acuità visiva"
                                            type="button"
                                        >
                    ...
                    <StaggerContainer>
                        <StaggerItem direction="up">
                            <h2 className="text-3xl sm:text-4xl font-bold mb-6">
                                Prenota il Tuo Esame dell&apos;Acuità Visiva
                            </h2>
                        ...
                        <StaggerItem direction="up">
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <button 
                                    ...
                                    aria-label="Prenota online un esame dell'acuità visiva"
                                    type="button"
                                >
                                    <Calendar className="w-5 h-5" />
                                    Prenota Online
