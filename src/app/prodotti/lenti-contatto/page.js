                        ...
                        <div className="mx-auto w-full max-w-md">
                            ...
                            <StaggerItem direction="up" blur>
                                <h1 className="mt-4 text-center font-extrabold leading-[0.95] tracking-tight">
                                    <span className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-zinc-900">LE NOSTRE</span>
                                    <span className="block text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-red-600">LENTI A</span>
                                    <span className="block text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-red-600">CONTATTO</span>
                                </h1>
                            </StaggerItem>
